...
if __name__ == "__main__":
    ...
    ascad_dataset = ReadASCADr(
        ...
        n_attack,
        n_validation,
        file_path=f"E:\\jingtong\\ASCAD\\ASCAD\\ASCADr\\ascad-variable-desync50.h5",
    ...
    model.load_weights('E:\jingtong\Code\Pre-trained model\ASCADr_short_traces\desync50\my_model.h5')
    ...
    plt.title('Desynchronization Nmax = 50')
    plt.show()
