...
def WSMCTCNN_model(classes, number_of_samples):
    ...
    x = Conv1D(kernel_size=8, strides=4, filters=38, activation='selu', padding='same')(x)
...
if __name__ == "__main__":
    ...
    model.load_weights('E:\jingtong\Code\Pre-trained model\ASCADr_long_traces\desync800\my_model.h5')
    ...
    plt.title('Desynchronization Nmax = 800')
    plt.show()
